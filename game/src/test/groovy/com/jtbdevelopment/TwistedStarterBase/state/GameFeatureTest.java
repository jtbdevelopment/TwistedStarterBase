...
public class GameFeatureTest {
    ...
    public void testGetGroupedFeatures() {
        ...
        map.put(GameFeature.Option1, Arrays.asList(GameFeature.Choice1, GameFeature.Choice2, GameFeature.Choice3));
        map.put(GameFeature.Option2, Arrays.asList(GameFeature.Option2Yes, GameFeature.Option2No));
        map.put(GameFeature.Option3, Arrays.asList(GameFeature.Solo, GameFeature.Collaborate, GameFeature.Compete));
