    ...
    public void testGetFeatures() {
        ...
        List<GameFeatureInfo> expected = Arrays.asList(
                new GameFeatureInfo(GameFeature.Option1,
                        Arrays.asList(new GameFeatureInfo.Detail(GameFeature.Choice1), new GameFeatureInfo.Detail(GameFeature.Choice2), new GameFeatureInfo.Detail(GameFeature.Choice3))),
                new GameFeatureInfo(GameFeature.Option2,
                        Arrays.asList(new GameFeatureInfo.Detail(GameFeature.Option2Yes), new GameFeatureInfo.Detail(GameFeature.Option2No))),
                new GameFeatureInfo(GameFeature.Option3,
                        Arrays.asList(new GameFeatureInfo.Detail(GameFeature.Solo), new GameFeatureInfo.Detail(GameFeature.Collaborate), new GameFeatureInfo.Detail(GameFeature.Compete))));
